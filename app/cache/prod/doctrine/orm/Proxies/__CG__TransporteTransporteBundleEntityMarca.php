 ...
 */
class Marca extends \Transporte\TransporteBundle\Entity\Marca implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Transporte\\TransporteBundle\\Entity\\Marca' . "\0" . 'id', '' . "\0" . 'Transporte\\TransporteBundle\\Entity\\Marca' . "\0" . 'descripcion', 'vehiculos');
        }
