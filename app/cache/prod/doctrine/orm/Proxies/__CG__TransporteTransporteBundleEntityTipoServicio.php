 ...
 */
class TipoServicio extends \Transporte\TransporteBundle\Entity\TipoServicio implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Transporte\\TransporteBundle\\Entity\\TipoServicio' . "\0" . 'id', '' . "\0" . 'Transporte\\TransporteBundle\\Entity\\TipoServicio' . "\0" . 'descripcion', 'contratos');
        }
