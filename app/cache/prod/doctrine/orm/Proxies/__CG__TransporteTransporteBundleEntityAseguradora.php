 ...
 */
class Aseguradora extends \Transporte\TransporteBundle\Entity\Aseguradora implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Transporte\\TransporteBundle\\Entity\\Aseguradora' . "\0" . 'id', '' . "\0" . 'Transporte\\TransporteBundle\\Entity\\Aseguradora' . "\0" . 'descripcion', 'polizas');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Aseguradora $proxy) {
