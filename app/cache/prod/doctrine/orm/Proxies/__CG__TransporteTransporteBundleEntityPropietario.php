 ...
 */
class Propietario extends \Transporte\TransporteBundle\Entity\Propietario implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Transporte\\TransporteBundle\\Entity\\Propietario' . "\0" . 'id', 'vehiculos', 'persona', '' . "\0" . 'Transporte\\TransporteBundle\\Entity\\Propietario' . "\0" . 'fechaAlta', '' . "\0" . 'Transporte\\TransporteBundle\\Entity\\Propietario' . "\0" . 'fechaBaja');
        }
