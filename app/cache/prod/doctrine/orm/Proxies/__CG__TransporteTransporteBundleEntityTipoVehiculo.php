 ...
 */
class TipoVehiculo extends \Transporte\TransporteBundle\Entity\TipoVehiculo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Transporte\\TransporteBundle\\Entity\\TipoVehiculo' . "\0" . 'id', '' . "\0" . 'Transporte\\TransporteBundle\\Entity\\TipoVehiculo' . "\0" . 'descripcion', 'vehiculos');
        }
